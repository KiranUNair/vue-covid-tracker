<template>
    <div class="grid md:grid-cols-2 gap-4">
        <!-- Box 1 -->
        <div class="shadow-md bg-blue-100 text-center p-10 rounded">
            <h3 class="text-blue-900 text-3xl font-bold mb-4">Cases</h3>
            <div class="text-2l mb-4">
        ...
        <!-- Box 2 -->
        <div class="shadow-md bg-blue-200 text-center p-10 rounded">
